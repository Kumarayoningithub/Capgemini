 ...
 */
@Entity
@Table(name = "tasksNew") // Optional: specify table name if different from class name
public class Task {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY) // Auto-increment primary key in order
    private Long id;
